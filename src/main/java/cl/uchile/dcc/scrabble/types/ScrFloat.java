...
public class ScrFloat implements IOperations{
    ...
    /**
     * Adds a ScrBinary to this ScrFloat, returning a ScrFloat
     * @param bin the ScrBinary to be added
     * @return a ScrFloat with the result
     */
    public ScrFloat add(ScrBinary bin){
        return new ScrFloat(this.getValue()+bin.toScrFloat().getValue());
    }

    /**
     * Subtracts a ScrBinary to this ScrFloat, returning a ScrFloat
     * @param bin the ScrBinary to be subtracted
     * @return a ScrFloat with the result
     */
    public ScrFloat subtract(ScrBinary bin){
        return new ScrFloat(this.getValue()-bin.toScrFloat().getValue());
    }

    /**
     * Multiplies this ScrFloat by a ScrBinary, returning a ScrFloat
     * @param bin the ScrBinary to be multiplied
     * @return a ScrInt with the result
     */
    public ScrFloat multiply(ScrBinary bin){
        return new ScrFloat(this.getValue()*bin.toScrFloat().getValue());
    }

    /**
     * Divides this ScrFloat by a ScrBinary, returning a ScrFloat
     * @param bin the ScrBinary to be divided
     * @return a ScrFloat with the result
     */
    public ScrFloat divide(ScrBinary bin){
        return new ScrFloat(this.getValue()/bin.toScrFloat().getValue());
    }
